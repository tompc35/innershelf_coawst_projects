...
export   ROMS_APPLICATION=INNERSHELF
...
export     MY_ROOT_DIR=/home/tconnolly/programs/COAWST
export     MY_PROJECT_DIR=/home/tconnolly/programs/work_COAWST/Projects/InnerShelf
...
# export            BINDIR=${MY_PROJECT_DIR}
  export            BINDIR=../work_COAWST/Projects/InnerShelf

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

# export       SCRATCH_DIR=${MY_PROJECT_DIR}/Build
  export       SCRATCH_DIR=../work_COAWST/Projects/InnerShelf/Build
