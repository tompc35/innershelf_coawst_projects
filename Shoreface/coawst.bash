...
export     MY_PROJECT_DIR=/cygdrive/d/tconnolly/programs/work_COAWST/Projects/Shoreface_v31
...
# export            BINDIR=${MY_PROJECT_DIR}
  export            BINDIR=../work_COAWST/Projects/Shoreface_v31

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

# export       SCRATCH_DIR=${MY_PROJECT_DIR}/Build
  export       SCRATCH_DIR=../work_COAWST/Projects/Shoreface_v31/Build
