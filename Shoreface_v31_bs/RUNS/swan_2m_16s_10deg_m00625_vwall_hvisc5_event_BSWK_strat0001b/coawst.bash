...
export     MY_ROOT_DIR=/cygdrive/d/tconnolly/programs/COAWST31_TC_BS
export     MY_PROJECT_DIR=/cygdrive/d/tconnolly/programs/work_COAWST/Projects/Shoreface_v31_bs
...
# export            BINDIR=${MY_PROJECT_DIR}
  export            BINDIR=../work_COAWST/Projects/Shoreface_v31_bs

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

# export       SCRATCH_DIR=${MY_PROJECT_DIR}/Build
  export       SCRATCH_DIR=../work_COAWST/Projects/Shoreface_v31_bs/Build
